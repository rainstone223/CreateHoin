...
const CONFIG = {
  ...
  LEVELS: [
    { name: "사원", size: 18, xpRequired: 0, image: "public/sawon.png" },
    { name: "대리", size: 23, xpRequired: 50, image: "public/daeri.png" },
    { name: "과장", size: 28, xpRequired: 110, image: "public/gwajang.png" },
    { name: "부장", size: 34, xpRequired: 180, image: "public/bujang.png" },
    { name: "사장", size: 41, xpRequired: 260, image: "public/sajang.png" },
